...
set ylabel 'time per measurement round'  font ",16"   # y-axis label
...
plot "average_time.txt" using 1:11 with linespoints title " p = 0.0005" ls 1, "average_time.txt" using 1:12 with linespoints title "p = 0.001" ls 2, "average_time.txt" using 1:13 with linespoints title "p = 0.005" ls 3
