...
plot "average_time.txt" using 1:11 with linespoints title " p = 0.0005" lt 1, "average_time.txt" using 1:12 with linespoints title "p = 0.001" lt 2, "average_time.txt" using 1:13 with linespoints title "p = 0.005" lt 3
