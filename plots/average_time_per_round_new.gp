...
set arrow from 15,18.535 to 17,17.80 nohead dashtype 2
plot "new_pe_latency.txt.csv" using 1:($3) with linespoints title "p = 0.001 phen" ls 2, "new_pe_latency.txt.csv" using 1:($5) with linespoints title "p = 0.005 phen" ls 3, "new_pe_latency.txt.csv" using 1:($9) with linespoints title "p = 0.001 cct" ls 1